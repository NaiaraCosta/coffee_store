...
public class OrderId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4920917288883778474L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderId\",\"namespace\":\"br.com.coffee.store.generated\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"}]}");
   ...
   */
  public static br.com.coffee.store.generated.OrderId.Builder newBuilder() {
    return new br.com.coffee.store.generated.OrderId.Builder();
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static br.com.coffee.store.generated.OrderId.Builder newBuilder(br.com.coffee.store.generated.OrderId.Builder other) {
    if (other == null) {
      return new br.com.coffee.store.generated.OrderId.Builder();
    } else {
      return new br.com.coffee.store.generated.OrderId.Builder(other);
    }
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static br.com.coffee.store.generated.OrderId.Builder newBuilder(br.com.coffee.store.generated.OrderId other) {
    if (other == null) {
      return new br.com.coffee.store.generated.OrderId.Builder();
    } else {
      return new br.com.coffee.store.generated.OrderId.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderId>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.coffee.store.generated.OrderId.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.coffee.store.generated.OrderId other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderId.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderId.Builder clearId() {
