...
public class CoffeeUpdateEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9172038924232977549L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CoffeeUpdateEvent\",\"namespace\":\"br.com.coffee.store.generated\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"OrderStatus\",\"symbols\":[\"PROCESSING\",\"READY_FOR_PICKUP\"]}}]}");
...
static {
  ...
  @Deprecated public br.com.coffee.store.generated.OrderStatus status;
   ...
   */
  public CoffeeUpdateEvent(java.util.UUID id, br.com.coffee.store.generated.OrderStatus status) {
    this.id = id;
    this.status = status;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: status = (br.com.coffee.store.generated.OrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public br.com.coffee.store.generated.OrderStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(br.com.coffee.store.generated.OrderStatus value) {
    this.status = value;
  }
   ...
   */
  public static br.com.coffee.store.generated.CoffeeUpdateEvent.Builder newBuilder() {
    return new br.com.coffee.store.generated.CoffeeUpdateEvent.Builder();
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static br.com.coffee.store.generated.CoffeeUpdateEvent.Builder newBuilder(br.com.coffee.store.generated.CoffeeUpdateEvent.Builder other) {
    if (other == null) {
      return new br.com.coffee.store.generated.CoffeeUpdateEvent.Builder();
    } else {
      return new br.com.coffee.store.generated.CoffeeUpdateEvent.Builder(other);
    }
  }
   ...
   * @return A new CoffeeUpdateEvent RecordBuilder
   */
  public static br.com.coffee.store.generated.CoffeeUpdateEvent.Builder newBuilder(br.com.coffee.store.generated.CoffeeUpdateEvent other) {
    if (other == null) {
      return new br.com.coffee.store.generated.CoffeeUpdateEvent.Builder();
    } else {
      return new br.com.coffee.store.generated.CoffeeUpdateEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CoffeeUpdateEvent>
    ...
    private br.com.coffee.store.generated.OrderStatus status;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.coffee.store.generated.CoffeeUpdateEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.coffee.store.generated.CoffeeUpdateEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.CoffeeUpdateEvent.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.CoffeeUpdateEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.CoffeeUpdateEvent.Builder setStatus(br.com.coffee.store.generated.OrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.CoffeeUpdateEvent.Builder clearStatus() {
      status = null;
    ...
    public CoffeeUpdateEvent build() {
      try {
        ...
        record.status = fieldSetFlags()[1] ? this.status : (br.com.coffee.store.generated.OrderStatus) defaultValue(fields()[1]);
        return record;
