...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6848828733239417032L;
  ...
  @Deprecated public br.com.coffee.store.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, br.com.coffee.store.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (br.com.coffee.store.generated.Address)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public br.com.coffee.store.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(br.com.coffee.store.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static br.com.coffee.store.generated.Store.Builder newBuilder() {
    return new br.com.coffee.store.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static br.com.coffee.store.generated.Store.Builder newBuilder(br.com.coffee.store.generated.Store.Builder other) {
    if (other == null) {
      return new br.com.coffee.store.generated.Store.Builder();
    } else {
      return new br.com.coffee.store.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static br.com.coffee.store.generated.Store.Builder newBuilder(br.com.coffee.store.generated.Store other) {
    if (other == null) {
      return new br.com.coffee.store.generated.Store.Builder();
    } else {
      return new br.com.coffee.store.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private br.com.coffee.store.generated.Address address;
    private br.com.coffee.store.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.coffee.store.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = br.com.coffee.store.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.coffee.store.generated.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.Store.Builder setAddress(br.com.coffee.store.generated.Address value) {
     ...
     * @return This builder.
     */
    public br.com.coffee.store.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(br.com.coffee.store.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(br.com.coffee.store.generated.Address.newBuilder());
        }
      }
    ...
    public br.com.coffee.store.generated.Store.Builder setAddressBuilder(br.com.coffee.store.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (br.com.coffee.store.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new br.com.coffee.store.generated.Address();
      }
