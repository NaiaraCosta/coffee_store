...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4106903243346662484L;
...
static {
  ...
  @Deprecated public br.com.coffee.store.generated.Size size;
   ...
   */
  public OrderLineItem(java.lang.String name, br.com.coffee.store.generated.Size size, java.lang.Integer quantity, java.math.BigDecimal cost) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (br.com.coffee.store.generated.Size)value$; break;
   ...
   */
  public br.com.coffee.store.generated.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(br.com.coffee.store.generated.Size value) {
    this.size = value;
  }
   ...
   */
  public static br.com.coffee.store.generated.OrderLineItem.Builder newBuilder() {
    return new br.com.coffee.store.generated.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static br.com.coffee.store.generated.OrderLineItem.Builder newBuilder(br.com.coffee.store.generated.OrderLineItem.Builder other) {
    if (other == null) {
      return new br.com.coffee.store.generated.OrderLineItem.Builder();
    } else {
      return new br.com.coffee.store.generated.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static br.com.coffee.store.generated.OrderLineItem.Builder newBuilder(br.com.coffee.store.generated.OrderLineItem other) {
    if (other == null) {
      return new br.com.coffee.store.generated.OrderLineItem.Builder();
    } else {
      return new br.com.coffee.store.generated.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
    ...
    private br.com.coffee.store.generated.Size size;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.coffee.store.generated.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.coffee.store.generated.OrderLineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder setSize(br.com.coffee.store.generated.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.coffee.store.generated.OrderLineItem.Builder clearCost() {
      cost = null;
    ...
    public OrderLineItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (br.com.coffee.store.generated.Size) defaultValue(fields()[1]);
