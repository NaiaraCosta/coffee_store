package br.com.coffee.store.producer;

import br.com.coffee.store.generated.CoffeeOrder;
...
public class CoffeeOrderProducer {
    ...
    private void handleSuccess(CoffeeOrder coffeeOrder, SendResult<String, CoffeeOrder> result) {
        ...
        log.info("Message sent successFully for the key: {}, and the value is {}, and the partition is {}", coffeeOrder.getId(), coffeeOrder, result.getRecordMetadata().partition());
